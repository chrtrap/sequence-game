...
# print(check_locked((4,6),test_board,1))


# hand = ["DK","HJ","S3","CQ","S4","DJ"]

# pick_cards= [(card_sqrs[i[0]], card_sqrs[i[1]], card_sqrs[i[2]]) for i in itertools.combinations(hand,3)]
# pick_cards2= [i for i in itertools.combinations(hand,3)]
# combinations = list(itertools.combinations(pick_cards[0],3))
#print(pick_cards2)
#print(test_board)
#hejsa = [(1,2,"asd"),(2,3,"a1"),(1,4,"A3")]

#add_pos = list_pos_pos(test_board, 0)
#rem_pos = list_pos_pos(test_board, 2)
# for J in ["HJ","SJ"]:
#     card_sqrs[J] = list_pos_pos(test_board, 2, J)
# for J in ["DJ","CJ"]:
#     card_sqrs[J] = list_pos_pos(test_board, 0, J)

#print(test_board)
#print(check_locked((4,3),test_board))
#test_board[3,5] = 0
#print(test_board)
#print(inv_card[(3,5)])
#print(board)
#print(eval_pos(hand, test_board, card_sqrs))
#print(test_board)
#print(list_pos_pos(test_board,0))
...
#test_board[6,4] = 1
#test_board[6,5] = 1
#print(seq_points(test_board))


##print(check_dead_card("CA",test_board))
#pick_cards = [(card_sqrs[i[0]], card_sqrs[i[1]], card_sqrs[i[2]]) for i in itertools.combinations(hand,3)]
#for picks in pick_cards:
    #combinations = list(itertools.product(*picks))
    #break

#print(test_board[combinations[0][0]])
...
#             combinations = list(itertools.product(*picks))
#             for combi in combinations:
#                 if chip_board[combi[0]] != 0 or chip_board[combi[1]] != 0 or chip_board[combi[2]] != 0:
#                     continue
#                 chip_board[combi[0]] = 1
#                 chip_board[combi[1]] = 1
#                 chip_board[combi[2]] = 1
#                 own, opp = seq_points(chip_board)
#                 dif = own - opp
#                 if dif >= best_dif:
#                     best_dif = dif
#                     best_dif_combi = combi
#                 chip_board[combi[0]] = 0
#                 chip_board[combi[1]] = 0
#                 chip_board[combi[2]] = 0
#         best_dif = -100000000000000000000
#         for pos in best_dif_combi:
#             chip_board[pos] = 1
#             own, opp = seq_points(chip_board)
